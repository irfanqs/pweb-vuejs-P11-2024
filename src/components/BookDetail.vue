<template>
	<div class="flex justify-center items-center min-h-screen bg-gray-100">
	  <div class="w-full max-w-xl sm:max-w-lg px-6 py-6 bg-white rounded-lg shadow-lg">
		...
		<div v-if="book" class="space-y-4">
		  <img :src="book.coverImage || 'path/to/default-image.jpg'" alt="Book Cover" class="w-full h-48 object-cover rounded-lg shadow-md" />
